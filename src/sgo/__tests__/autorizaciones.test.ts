...
describe('bandeja de autorizaciones SGO', () => {
  it('reúne las decisiones pendientes de cada fuente sin duplicar registros', () => {
    ...
    const mejora = { id: 'm-1', titulo: 'Mejorar aparejo', detectadoPor: 'lara', detectadoEn: fecha, actualizadoEn: fecha, estado: 'abierto', severidad: 'alta', areaId: 'bobinado_rural', mejora: { decision: 'pendiente', prioridad: 'alta' } } as EventoSGO
